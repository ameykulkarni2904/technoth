		...
		<div class="row">
                    <div class="col-lg-6">
                        ...
                        <table>
							...
							<c:forEach items="${lst}" var="sr">
								<tr>
									<td>
										
											<c:out value="${sr.getEmployee_id()}" />
								</td>
									<td><c:out value="${sr.getEmployee_name()}" /></td>
									<td><c:out value="${sr.getMail_id()}" /></td>
									<td><c:out value="${sr.getTeam_id()}" /></td>
									<td><c:out value="${sr.getContact_no()}" /></td>
	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header">Participant Details</h1>
						<ol class="breadcrumb">
	...
	<div class="col-lg-4" style="width: 780px ">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-money fa-fw"></i> Participant</h3>
                            </div>
