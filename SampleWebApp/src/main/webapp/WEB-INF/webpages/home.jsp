...
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
       <html >
        ...
        <body style="background-image: url(resources/img/banner.jpg)">
            <!-- Begin Page Content -->
            <div id="container">
             <sf:form modelAttribute="admin" method="POST">
    			  ...
    			  <label for="loginmsg" style="color:hsla(0,100%,50%,0.5); font-family:"Helvetica Neue",Helvetica,sans-serif;"><?php  echo @$_GET['msg'];?></label>
                   ...
                   <sf:input path="emailID"/><sf:errors path="emailID"></sf:errors>
                      
                       <label for="password">Employee ID:</label>
                     <sf:input path="empID"/><sf:errors path="empID"></sf:errors>
                      
                      
                      <label for="password">Password :</label>
                     <sf:input path="pwd"/><sf:errors path="pwd"></sf:errors>
