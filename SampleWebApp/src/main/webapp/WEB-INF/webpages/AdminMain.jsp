...
<link rel="stylesheet" type="text/css"
	href="<c:url value="/resources/cssteam/plugins/morris.css"/>">
		...
		<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
			...
			<div class="collapse navbar-collapse navbar-ex1-collapse">
				<ul class="nav navbar-nav side-nav">
					...
					<li><a href="schedule1/add"><i class="fa fa-fw fa-edit"></i>Schedule
							Generation</a></li>

					<li><a href="displayproblem"><i class="fa fa-fw fa-edit"></i>Problem
							Statement Status</a></li>

					<li><a href="/uploadFileXls"><i class="fa fa-fw fa-edit"></i>Upload
							Participant List</a></li>
